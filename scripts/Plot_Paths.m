...
plot(UI.t, ...
    sqrt( (XYZ_path(:,1) - XYZ_path_filtered(:,1)).^2 ...
    + (XYZ_path(:,2) - XYZ_path_filtered(:,2)).^2 ...
    + (XYZ_path(:,3) - XYZ_path_filtered(:,3)).^2), ...
    'k')
plot(UI.t, ...
...
plot(UI.t, ...
    sqrt( (Euler_path(:,1) - Euler_path_filtered(:,1)).^2 ...
    + (Euler_path(:,2) - Euler_path_filtered(:,2)).^2 ...
    + (Euler_path(:,3) - Euler_path_filtered(:,3)).^2), ...
    'k')
plot(UI.t, ...
